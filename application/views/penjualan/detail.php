                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $details[0]->customer_id;?></td>
                                        <td><?php echo $details[0]->total_item;?></td>
                                        <td>Rp<?php echo number_format($details[0]->total_price);?></td>
                                        <td><?php echo $details[0]->is_cash == 1 ? "Cash" : "Debit";?></td>
                                        <!-- <td><span class="label label-warning"><?php echo $details[0]->is_cash == 1 ? "" : $details[0]->pay_deadline_date;?></span></td> -->
